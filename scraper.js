            ...
            switch (_a.label) {
                ...
                case 5:
                    ...
                    return [4 /*yield*/, page.$$eval(SELECTOR + suffix, function (elements) { return elements.map(function (element) {
                            var _a, _b, _c;
                            return ({
                                name: ((_b = (_a = element.querySelector("ember-view lt-line-clamp lt-line-clamp--single-line BEFuKteXeTCNsLeFZdKrWGvUcyRoKfnzlENEt-black")) === null || _a === void 0 ? void 0 : _a.textContent) === null || _b === void 0 ? void 0 : _b.trim()) || "",
